...
path="license2.jpeg" #Use the path to the image to test here
                    #note: python file and image should be in same folder
result=license_detect(path)
print("license plate:",result) #check terminal for the license plate as a string
